...
<template>
    <section class="bg-gray-800 p-6 rounded-lg shadow-md">
        <header>
            <h2 class="text-lg font-medium text-pink-400">Update Password</h2>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing" class="bg-indigo-500">Save</PrimaryButton>
...
<style scoped>
/* Anda bisa menambahkan gaya spesifik di sini jika perlu */
</style>
